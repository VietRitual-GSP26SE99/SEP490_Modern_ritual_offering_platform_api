...
const Carousel: React.FC<{ 
  ...
  return (
    <div className="relative h-[640px] md:mx-8 md:mt-8 rounded-[3rem] overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] group">
      {/* Slides */}
      {slides.map((slide, idx) => (
        ...
        >
          ...
          <div className="relative z-10 h-full flex flex-col justify-center px-12 md:px-24 max-w-5xl">
            {/* Subtitle Badge */}
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-xl px-5 py-2.5 rounded-2xl border border-white/20 mb-8 w-fit animate-in fade-in slide-in-from-left-8 duration-700">
            ...
            <h1 
              className="text-white text-5xl md:text-8xl font-display font-black leading-[1.05] mb-8 animate-in fade-in slide-in-from-left-12 duration-1000 delay-100 drop-shadow-[0_4px_8px_rgba(0,0,0,0.3)]"
            ...
            {/* Description */}
            <p className="text-white/80 text-lg md:text-2xl font-medium leading-relaxed mb-12 max-w-2xl animate-in fade-in slide-in-from-left-16 duration-1000 delay-200">
              {slide.description}
            </p>
            ...
            <div className="flex flex-wrap gap-5 animate-in fade-in slide-in-from-left-20 duration-1000 delay-300">
              <button 
                ...
                className="group/btn relative overflow-hidden bg-white text-primary px-12 py-5 rounded-[1.25rem] font-black text-xs uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-[0_10px_30px_-5px_rgba(255,255,255,0.2)]"
              >
